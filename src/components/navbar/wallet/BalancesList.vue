<template>
    <b-nav-item-dropdown id="nav-wallet-wrapper"
                         v-if="activeWallet"
                         no-caret>
      <template slot="button-content"
        ...
        <b-row no-gutters>
          <b-col>
            ...
            <b-row no-gutters>
              <b-col cols="12" class="d-flex ">
                <i class="arc arc-triangle-down mt-1 mr-2"/>
                <small>
                  View my wallet
                </small>
              </b-col>
          ...
          <b-col cols="auto" class="text-right ml-auto">
            <b-button variant="arc-secondary" class="wallet-button">
        ...
        <b-dropdown-item class="wallet-dropdown text-right px-3 py-2"
