  ...
  en: {
    ...
    account: {
      ...
      deposit: {
        ...
        skrillAndNetellerDisabled: 'Automatic deposits for Neteller are currently unavailable, you are still able to deposit manually by wiring the deposit amount to <a href="mailt:payments@arcanebet.com">payments@arcanebet.com</a> and our support team will credit your account accordingly.',
